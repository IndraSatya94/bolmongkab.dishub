        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid animate__animated animate__bounceInDown">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Halaman Bupati</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('bupati.create') }}"><i class="fas fa-plus"></i>
                            Tambah</a>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-responsive animate__animated animate__bounceInRight animate__fast">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td><img src="/image/bupati/{{ $bpati->image }}" width="100px"></td>
                                        <td>{{ $bpati->nama }}</td>
                                        <td>{{ $bpati->body }}</td>
                                        <td>
                                            <form action="{{ route('bupati.destroy',$bpati->id) }}" method="POST"
                                                ...
                                                <a class="btn btn-warning"
                                                    href="{{ route('bupati.edit',$bpati->id) }}"><i
                            ...
                            <div class="pagination" style="margin-top:20px;">
                                {!! $bupati->links('Template.pagination') !!}
                            </div>
                        </div>
                    </div>
