  ...
  <header id="header" class="header fixed-top">
    ...
    <main id="main">
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Lalu Lintas dan Angkutan</h2>
                    <ol>
                        <li><a href="index.html">Home</a></li>
                        <li>Lalu Lintas dan Angkutan</li>
                    </ol>
                </div>
        ...
        <section id="visimisi" class="visimisi">
            @foreach ($lalulintas as $vmisi)
            <div class="container">
                <div class="judul">
                    <h2 class="animate__animated animate__bounceInDown">BIDANG LALU LINTAS DAN ANGKUTAN</h2>
                    <hr>
