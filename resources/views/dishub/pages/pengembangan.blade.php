  ...
  <header id="header" class="header fixed-top">
    ...
    <main id="main">
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Pengembangan dan Keselamatan</h2>
                    <ol>
                        <li><a href="index.html">Home</a></li>
                        <li>Pengembangan dan Keselamatan</li>
                    </ol>
                </div>
        ...
        <section id="visimisi" class="visimisi">
            ...
            <div class="container">
                <div class="judul">
                    <h2 class="animate__animated animate__bounceInDown">BIDANG PENGEMBANGAN dan KESELAMATAN</h2>
                    <hr>
                    <img class="animate__animated animate__bounceInLeft animate__fast" src="image/statiks/{{ $p->image }}"
                        alt="">
                </div>
                <p class="animate__animated animate__bounceInRight animate__fast">{{ $p->body }}</p>
            </div>
            @endforeach
