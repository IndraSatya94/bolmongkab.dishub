        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Kelola Halaman Pelayanan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <form action="{{ route('pelayanan.update',$pelayanan->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="custom-select" id="inputGroupSelect01" name="posisi" id="posisi">
                                            <option value="{{ $pelayanan->posisi }}">{{ $pelayanan->posisi }}
                                            </option>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Link:</strong>
                                    <input type="text" name="link" class="form-control" value="{{ $pelayanan->link }}"
                                        placeholder="Link">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <img src="/image/pelayanan/{{ $pelayanan->icon }}" width="300px"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 text-left">
                                ...
                                <a class="btn btn-light" href="{{ route('pelayanan.index') }}">Cancel</a>
                            </div>
