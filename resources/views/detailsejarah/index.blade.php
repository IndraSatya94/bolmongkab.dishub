            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('detailsejarah.create') }}"><i
                    ...
                    <div class="card text-center card-primary" style="margin-top:10px;">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                <thead class="table-primary animate__animated animate__bounceInRight animate__fast">
                                    <tr>
                                        <th>No</th>
                                        <th>Name</th>
                                        <th>Body</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $dsejarah->body }}</td>
                                        <td>
                                            <form action="{{ route('detailsejarah.destroy',$dsejarah->id) }}"
                                                method="POST" onSubmit="return confirm('Hapus Data ?')">

                                                <a class="btn btn-warning"
                                                    href="{{ route('detailsejarah.edit',$dsejarah->id) }}"><i
                            ...
                            <div class="pagination" style="margin-top:20px;">
                                {!! $detailsejarah->links('Template.pagination') !!}
                            </div>
                        </div>
                    </div>
