        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Halaman Detail Sejarah</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                ...
                <div class="card card-primary" style="margin-top:10px;">
                    ...
                    <div class="card-body">
                        <form action="{{ route('detailsejarah.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 text-left">
                                ...
                                <a class="btn btn-light" href="{{ route('sejarah.index') }}">Batal</a>
                            </div>
