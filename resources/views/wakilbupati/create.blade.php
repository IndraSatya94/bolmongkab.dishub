                    ...
                    <div class="card-body">
                        <form action="{{ route('wakilbupati.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Body:</strong>
                                    <textarea class="form-control" value="{{ old('body') }}" style="height:150px" name="body"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 text-left">
                                ...
                                <a class="btn btn-light" href="{{ route('wakilbupati.index') }}">Batal</a>
                            </div>
