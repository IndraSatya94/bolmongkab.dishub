        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid animate__animated animate__bounceInDown">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Halaman Pimpinan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('pimpinan.create') }}"><i class="fas fa-plus"></i>
                            Tambah</a>
                    </div>
                    ...
                    <div class="card text-center card-primary" style="margin-top:10px;">
                        ...
                        <div class="card-body">
                                        ...
                                        <td>
                                            <form action="{{ route('pimpinan.destroy',$pimpin->id) }}" method="POST"
                                                ...
                                                <a class="btn btn-warning"
                                                    href="{{ route('pimpinan.edit',$pimpin->id) }}"><i
                            ...
                            <div class="pagination" style="margin-top:20px;">
                                {!! $pimpinan->links('Template.pagination') !!}
                            </div>
                        </div>
                    </div>
