            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('banner.create') }}"><i class="fas fa-plus"></i>
                            Tambah</a>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered animate__animated animate__bounceInRight animate__fast">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td><img src="/image/banner/{{ $ban->image }}" width="100px"></td>
                                        <td>{{ $ban->kolom }}</td>
                                        <td>{{ $ban->link }}</td>
                                        <td>
                                            <form action="{{ route('banner.destroy',$ban->id) }}" method="POST"
                                                ...
                                                <a class="btn btn-warning" href="{{ route('banner.edit',$ban->id) }}"><i
