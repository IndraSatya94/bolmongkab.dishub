        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid animate__animated animate__bounceInDown">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Halaman Puskesmas</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('puskesmas.create') }}"><i class="fas fa-plus"></i>
                            Tambah</a>
                    </div>
                    ...
                    <div class="card text-center card-primary" style="margin-top:10px;">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered animate__animated animate__bounceInRight animate__fast">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td>{{ $puskesma->nama }}</td>
                                        <td>{{ $puskesma->alamat }}</td>
                                        <td>
                                            <form action="{{ route('puskesmas.destroy',$puskesma->id) }}" method="POST"
                                                onSubmit="return confirm('Hapus Data ?')">

                                                <a class="btn btn-warning"
                                                    href="{{ route('puskesmas.edit',$puskesma->id) }}"><i
                            ...
                            <div class="pagination" style="margin-top:20px;">
                                {!! $puskesmas->links('Template.pagination') !!}
                            </div>
                        </div>
                    </div>
