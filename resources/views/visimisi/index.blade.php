            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('visimisi.create') }}"><i class="fas fa-plus"></i>
                            Tambah</a>
                    </div>
                    ...
                    <div class="card text-center card-primary" style="margin-top:10px;">
                        ...
                        <div class="card-body">
                                        ...
                                        <td>
                                            <form action="{{ route('visimisi.destroy',$vmisi->id) }}" method="POST"
                                                ...
                                                <a class="btn btn-info"
                                                    href="{{ route('visimisi.show',$vmisi->id) }}">Show</a>

                                                <a class="btn btn-warning"
                                                    href="{{ route('visimisi.edit',$vmisi->id) }}"><i
                            ...
                            <div class="pagination" style="margin-top:20px;">
                                {!! $visimisi->links('Template.pagination') !!}
                            </div>
                        </div>
                    </div>
