        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid animate__animated animate__bounceInDown">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Halaman Visi dan Misi</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="button-buat animate__animated animate__bounceInDown">
                        <a class="btn btn-primary" href="{{ route('strukturs.create') }}"><i class="fas fa-plus"></i>
                            Tambah</a>
                    </div>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered animate__animated animate__bounceInRight animate__fast">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td><img src="/image/struktur/{{ $struktur->image }}" width="100px"></td>
                                        <td>{{ $struktur->body }}</td>
                                        <td>
                                            <form action="{{ route('strukturs.destroy',$struktur->id) }}" method="POST"
                                                ...
                                                <a class="btn btn-info"
                                                    href="{{ route('strukturs.show',$struktur->id) }}">Show</a>

                                                <a class="btn btn-warning"
                                                    href="{{ route('strukturs.edit',$struktur->id) }}"><i
                            ...
                            <div class="pagination" style="margin-top:20px;">
                                {!! $strukturs->links('Template.pagination') !!}
                            </div>
                        </div>
                    </div>
